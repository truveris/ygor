...
func TestModuleAliasUsageOnNoParams(t *testing.T) {
	...
	m := &AliasModule{}
	m.Init(srv)
	m.AliasPrivMsg(srv, &IRCInputMessage{
		ReplyTo: "#test",
		Args:    []string{},
	})
...
func TestModuleAliases(t *testing.T) {
	...
	m := &AliasModule{}
	m.Init(srv)
	m.AliasesPrivMsg(srv, &IRCInputMessage{
		ReplyTo: "#test",
		Args:    []string{},
	})
...
func TestModuleUnaliasUsage(t *testing.T) {
	...
	m := &AliasModule{}
	m.Init(srv)
	m.UnAliasPrivMsg(srv, &IRCInputMessage{
		ReplyTo: "#test",
		Args:    []string{},
	})
...
func TestModuleGrepUsage(t *testing.T) {
	...
	m := &AliasModule{}
	m.Init(srv)
	m.GrepPrivMsg(srv, &IRCInputMessage{
		ReplyTo: "#test",
		Args:    []string{},
	})
...
func TestModuleRandom(t *testing.T) {
	...
	m := &AliasModule{}
	m.Init(srv)
	m.RandomPrivMsg(srv, &IRCInputMessage{
		ReplyTo: "#test",
		Args:    []string{"o"},
	})
